    ...
    <div class="container-fluid mt-4">
        <div class="row">
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    <img src="https://c0.wallpaperflare.com/preview/81/794/554/learn-grow-education-stairs.jpg" alt="..." style="width: 100%; height: 300px;">
                    <div class="card-body">
                        <h5 class="card-title">Student's Information</h5>
                        <form action="{{ url('/shows/'.$student->id) }}" method="post">
                            @csrf
                          
                            
                              <div class="form-group">
                                <label>Profile</label>
                                <img src="{{Storage::url($student->img)}}" name="img" class="form-control"  placeholder="Enter cne" style="width:100%; height: 200px;">
                            </div>
                            <div class="form-group">
                                <label>CNE</label>
